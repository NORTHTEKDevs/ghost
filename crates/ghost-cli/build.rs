...
fn main() {
    ...
    res.set("CompanyName", "Northtek (FrostByte LLC)")
        ...
        .set("FileDescription", "Ghost desktop automation CLI")
        .set("InternalName", "ghost")
        .set("OriginalFilename", "ghost.exe")
...
<assembly xmlns="urn:schemas-microsoft-com:asm.v1" manifestVersion="1.0">
  <assemblyIdentity type="win32" name="Northtek.Ghost.ghost" version="{four_part}"/>
  <description>Ghost desktop automation CLI</description>
