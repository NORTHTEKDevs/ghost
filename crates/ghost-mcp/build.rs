...
fn main() {
    ...
    res.set("CompanyName", "Northtek (FrostByte LLC)")
        ...
        .set("FileDescription", "Ghost desktop automation MCP server")
        .set("InternalName", "ghost-mcp")
        .set("OriginalFilename", "ghost-mcp.exe")
...
<assembly xmlns="urn:schemas-microsoft-com:asm.v1" manifestVersion="1.0">
  <assemblyIdentity type="win32" name="Northtek.Ghost.ghost-mcp" version="{four_part}"/>
  <description>Ghost desktop automation MCP server</description>
